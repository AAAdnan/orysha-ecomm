    ...
    <section className="container mx-auto px-6 p-10">
      ...
      <div className="flex items-center flex-wrap mb-20">
        <div className="w-full md:w-1/2">
          ...
          <p className="text-white mb-8">Embrace the power of the ancient orysha</p>
        </div>
        <div className="w-full md:w-1/2">
      ...
      <div className="flex items-center flex-wrap mb-20">
        ...
        <div className="w-full md:w-1/2 pl-10">
          <h4 className="text-3xl text-white font-bold mb-3">Style</h4>
          <p className="text-white mb-8">Our range of snapback caps offer an unprecedented range of styles and fashion.</p>
        </div>
      </div>
      <div className="flex items-center flex-wrap mb-20">
        <div className="w-full md:w-1/2">
          <h4 className="text-3xl text-white font-bold mb-3">Taste</h4>
          <p className="text-white mb-8">The orysha are an ancient group of gods</p>
        </div>
        <div className="w-full md:w-1/2">
