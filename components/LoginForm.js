...
const LoginForm = ({ loggedIn, ...props }) => {
  ...
  return (
    ...
    <img src="/africa-background.jpg" alt="background" className="object-cover object-center h-screen w-full rounded-full"/>
      <div className="absolute inset-0 opacity-75 bg-black flex flex-col justify-center items-center shadow-lg">
        <h1 className="text-6xl roboto font-bold text-orange-600 mb-24">Login</h1>
